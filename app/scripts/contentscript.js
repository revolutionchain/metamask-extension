...
// contexts
const CONTENT_SCRIPT = 'revolink-contentscript';
const INPAGE = 'revolink-inpage';
const PHISHING_WARNING_PAGE = 'revolink-phishing-warning-page';

// stream channels
const PHISHING_SAFELIST = 'revolink-phishing-safelist';
const PROVIDER = 'revolink-provider';
